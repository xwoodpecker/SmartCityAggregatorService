...
public class AirqualityController {
    ...
    ResponseEntity<PagedModel<Airquality>> between(@RequestParam Date startTime, @RequestParam Date endTime, @Parameter(hidden = true) Pageable pageable)
    {
    ...
    EntityModel<Airquality> betweenAverage(@RequestParam Date startTime, @RequestParam Date endTime)
    {
        //todo
        //todo avg entity
        return one((long) 1);
    ...
    public ResponseEntity<PagedModel<Airquality>> bySensorInTimeframe(@RequestParam Date startTime, @RequestParam Date endTime, @PathVariable Long sensorId, @Parameter(hidden = true) Pageable pageable)
    {
        //todo
        return all(pageable);
    }
